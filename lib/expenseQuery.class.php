...
class ExpenseQuery extends CommonInvoiceQuery
{
  
  public static function create($conn = null, $class = null)
  {
    $q = new ExpenseQuery($conn);
    $q->from('Expense i')
   ...
   * @return ExpenseQuery the same instance
   ...
   * one passed as parameter.
   * @param mixed date value
   * @return ExpenseFinder the same instance
   * @author Carlos Escribano <carlos@markhaus.com>
   */
